...
int object(int number, int dia, int a, int b, int c, int d) { //a - ��������� ������
  // b- ������� ������
  //dia 1-����� ����
  //dia 2-�������� �� �������� ���� �� ����
  //dia 3-������ ����

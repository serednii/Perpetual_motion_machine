...
//int ss=5;
rectfill(buffer_bocka[1], hurina_bocka/3 , 0, hurina_bocka/3*2, barrelHeight*0.2, 0x5c8fff);
rectfill(buffer_bocka[1], 0,(int)y_vusota, hurina_bocka, barrelHeight, 0xdc8fff);
...
//rectfill(buffer_bocka, 0, 20, hurina_bocka, barrelHeight, 0xdc8fff);
//rectfill(buffer_bocka_vuxod, 0, 0, hurina_bocka/3, barrelHeight*0.2, 0xdc8fff);
...
boccka()
    ...
    void Set_Boccka()
        {
        int a=1;
        rectfill(buffer_bocka[a], hurina_bocka/3 , 0, hurina_bocka/3*2, barrelHeight*0.2, 0x5c8fff);
        rectfill(buffer_bocka[a], 0,y_vusota, hurina_bocka, barrelHeight, 0xdc8fff);

...
rectfill(buffer_bocka[1], 0, (int)y_vusota, barrelWidth, y_vusota+rob_vusota*pol_porch, 0x5c8fff);
rectfill(buffer_bocka[1], 0 , (int)y_vusota+rob_vusota*pol_porch, barrelWidth, y_vusota+rob_vusota*pol_porch+(rob_vusota/6), 0x2c8f2f);
...
boccka()
    ...
    void Set_Boccka()
        ...
        rectfill(buffer_bocka[a], 0, y_vusota, barrelWidth, y_vusota+rob_vusota*pol_porch, 0x5c8fff);
        rectfill(buffer_bocka[a], 0 , y_vusota+rob_vusota*pol_porch, barrelWidth, y_vusota+rob_vusota*pol_porch+(rob_vusota/6), 0x2c8f2f);
